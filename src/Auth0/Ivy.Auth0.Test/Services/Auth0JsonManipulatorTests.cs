...
{
    public class Auth0JsonManipulatorTests : Auth0TestBase
    {
        ...
        private readonly Mock<IAuth0ConfigurationProvider> _mockConfig;
        ...
        public Auth0JsonManipulatorTests()
        {
            ...
            _mockConfig = new Mock<IAuth0ConfigurationProvider>();

            var containerGen = ServiceLocator.Instance.Resolve<IContainerGenerator>();

            base.ConfigureContainer(containerGen);

            containerGen.RegisterInstance<IAuth0ConfigurationProvider>(_mockConfig.Object);
