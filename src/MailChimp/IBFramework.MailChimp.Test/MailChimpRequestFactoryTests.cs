...
using System.Text;
using System;
using IBFramework.MailChimp.Test.Base;
using IBFramework.MailChimp.Core.Services;
using Moq;
using IBFramework.MailChimp.Core.Providers;
using IBFramework.IoC.Core;
using IBFramework.MailChimp.Core.Models;

namespace IBFramework.MailChimp.Test
{
    public class MailChimpRequestFactoryTests : MailChimpTestBase
    {
        ...
        public MailChimpRequestFactoryTests()
        {
            ...
            containerGenerator.GetServiceCollection().AddLogging();
